...
var api = module.exports = {
     ...
     */
    load: function (credentials, secret) {
        dirty = false;
        ...
        if (runtime.storage && runtime.storage.projects && !secret) {
            // projects enabled
        ...
        if (secret) {
            defaultKey = crypto.createHash('sha256').update(secret).digest();
            encryptionKey = defaultKey;
            encryptionEnabled = true;
            encryptionKeyType = "API";
        }
        else if (encryptionKeyType === '') {
            var defaultKey;
            try {
