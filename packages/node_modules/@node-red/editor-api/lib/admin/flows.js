    ...
    post: function(req,res) {
        ...
        if (opts.deploymentType !== 'reload') {
            if (version === "v1") {
                ...
                var body = req.body;
                if (false && body.hasOwnProperty("flows")) {
                    opts.flows = body.flows;
                    if (body.hasOwnProperty("credentials")) {
                        opts.credentials = body.credentials;
                    }
                    if (body.hasOwnProperty("credentialSecret")) {
                        opts.credentialSecret = body.credentialSecret;
                    }
                }
                else {
                    opts.flows = req.body;
