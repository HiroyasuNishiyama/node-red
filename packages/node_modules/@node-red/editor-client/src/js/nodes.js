...
RED.nodes = (function() {
    ...
    function replaceNodeID(node, old_id, new_id) {
        if (node.id == old_id) {
            node.id = new_id;
        }
        if (node.z == old_id) {
        ...
        if (flow) {
            flow.forEach(function (n) {
                replaceNodeID(n, old_id, new_id);
            });
        }
    }
    
    function replaceSubflowID(sf) {
        if (sf.exportName && (sf.exportName !== "")) {
            var old_id = sf.id;
            var new_id = "subflow:"+sf.exportName;
            var new_id = sf.exportName;
            replaceNodeID(sf, old_id, new_id);
        }
    }
