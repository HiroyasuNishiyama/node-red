...
RED.palette.editor = (function() {
    ...
    function refreshSubflowNode(sf) {
        ...
        if (!nodeEntries.hasOwnProperty(name)) {
            ...
            var nodeEntry = nodeEntries[name].elements;
            var errorRow = nodeEntry.errorRow;
            var incomplete = sf.incomplete();
            if (incomplete.length > 0) {
                var errorList = nodeEntry.errorList;
                errorList.empty();
                incomplete.forEach(function (e) {
                    $("<li/>").text(RED._("subflow.errors.incomplete", {node: e})).appendTo(errorList);
                });
                errorRow.show();
            }
            else {
