...
RED.editor = (function() {
    ...
    function buildInfoForm(container,node) {
        var dialogForm = $('<form class="dialog-form form-horizontal" autocomplete="off"></form>').appendTo(container);
        ...
        $("<label/>", {
            for: "subflow-info-input-name",
            "data-i18n": "editor:subflow.name"
        }).appendTo(nameRow);
        $("<input/>", {
            id: "subflow-info-input-name",
            type: "text"
        }).appendTo(nameRow);
        $("#subflow-info-input-name").val(node.name);
        ...
        licenseSelector.append($("<option/>").val("_custom_").text(RED._("editor:subflow.addLicense")));
        ...
        $("#subflow-info-input-license").val(node.license||"none");
        ...
        $("#subflow-info-input-version").val(node.version);
        ...
        $("#subflow-info-input-keyword").val(node.keyword);
        ...
        $("#subflow-info-input-author").val(node.author);
        ...
        $("#subflow-info-input-desc").val(node.desc);
    }
    ...
    function showEditSubflowDialog(subflow) {
        ...
        var trayOptions = {
            ...
            open: function(tray) {
                ...
                buildInfoForm(infoTab.content, editing_node);
