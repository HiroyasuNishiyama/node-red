...
RED.view = (function() {
    ...
    function isIncomplete(d) {
        var def = d._def;
        if (def && def.hasOwnProperty("incomplete")) {
            var ic = def.incomplete();
            console.log("; ic", ic);
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function(d,i) {
                    ...
                    var mainRect = node.append("rect")
                        ...
                        .classed("red-ui-flow-node-unknown",function(d) {
                            console.log("; D:", d, (d._def.incomplete ? d._def.incomplete() : null));
                            return (d.type == "unknown") || isIncomplete(d); })
                        .attr("rx", 5)
                        .attr("ry", 5)
                        .attr("fill",function(d) { return RED.utils.getNodeColor(d.type,d._def); /*d._def.color;*/})
                        .on("mouseup",nodeMouseUp)
