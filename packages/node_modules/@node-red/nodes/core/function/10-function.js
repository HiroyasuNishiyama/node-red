...
module.exports = function(RED) {
    ...
    function FunctionNode(n) {
        ...
        this.init = n.init;
        this.finish = n.finish;
        this.requires = n.requires;
        ...
        node.requires.forEach(function (r) {
            var name = r.name;
            var val = r.val;
            if (!sandbox.hasOwnProperty(name)) {
                sandbox[name] = require(val);
            }
            else {
                console.log("; name " +name +" already defined");
            }
        });
        ...
        try {
            ...
            if (this.init != "") {
                vm.runInContext(this.init, context);
            }
            ...
            this.on("close", function() {
                if (node.finish !== "") {
                    vm.runInContext(node.finish, context);
                }
